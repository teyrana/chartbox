...
#ifndef FLATBUFFERS_GENERATED_CELLCACHE_CHARTBOX_IO_FLATBUFFER_H_
#define FLATBUFFERS_GENERATED_CELLCACHE_CHARTBOX_IO_FLATBUFFER_H_
...
inline flatbuffers::Offset<Cell> CreateCellDirect(
  ...
  return chartbox::io::flatbuffer::CreateCell(
      _fbb,
      origin,
      height,
      width,
...
inline const chartbox::io::flatbuffer::Cell *GetCell(const void *buf) {
  return flatbuffers::GetRoot<chartbox::io::flatbuffer::Cell>(buf);
}

inline const chartbox::io::flatbuffer::Cell *GetSizePrefixedCell(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<chartbox::io::flatbuffer::Cell>(buf);
}

inline bool VerifyCellBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<chartbox::io::flatbuffer::Cell>(nullptr);
}

inline bool VerifySizePrefixedCellBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<chartbox::io::flatbuffer::Cell>(nullptr);
}

inline void FinishCellBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<chartbox::io::flatbuffer::Cell> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_CELLCACHE_CHARTBOX_IO_FLATBUFFER_H_
